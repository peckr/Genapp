package com.example.genapp.data;

import android.os.AsyncTask;
import android.util.Log;

import com.example.genapp.data.model.LoggedInUser;
...
public class LoginDataSource {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Result<LoggedInUser> > {
        ...
        protected Result<LoggedInUser> doInBackground(Void... params) {
            ...
            try {
                url = new URL(Configuraciones.urlServer+"logingen?params="+dataecriptada+"|"+encrypted.initVector);
            ...
            if (paramsx[0].trim().toString().equals("S") ){
               ...
               // Log.d("Usuario","entro a else "+paramsx[0].trim()+"-"+paramsx[1].trim());
                switch (Integer.parseInt(paramsx[1].trim())){
